...
import { registerOpsPartnerApplicationRoutes } from "./routes/v1/ops_partner_applications";
import { registerOpsFunnelScenarioRoutes } from "./routes/v1/ops_funnel_scenarios";
...
import { registerOpsMatchingWeightsRoutes } from "./routes/v1/ops_matching_weights";
import { registerOpsFunnelMatchingDebugRoutes } from "./routes/v1/ops_funnel_matching_debug";
...
registerOpsPartnerApplicationRoutes(app, admin);
registerOpsFunnelScenarioRoutes(app, admin);
registerOpsPartnerTaxonomyRoutes(app, admin);
registerOpsPartnersRoutes(app, admin);
registerOpsMatchingWeightsRoutes(app, admin);
registerOpsFunnelMatchingDebugRoutes(app, admin);
