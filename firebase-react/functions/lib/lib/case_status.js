...
exports.decideCaseStatusByDocumentReview = decideCaseStatusByDocumentReview;
exports.decideCaseStatusByDocumentComplete = decideCaseStatusByDocumentComplete;
...
function decideCaseStatusByDocumentReview(from, decision) {
    if (isTerminal(from))
        return null;
    if (decision === "needs_fix")
        return "waiting_user";
    if (decision === "ok" && from === "waiting_user")
        return "waiting_partner";
    return null;
}
function decideCaseStatusByDocumentComplete(from) {
    if (isTerminal(from))
        return null;
...
//# sourceMappingURL=case_status.js.map